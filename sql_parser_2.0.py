...
# path = '/Users/dherriott/Documents/Cube/testing-mi-build-service/central_mi/bau_scripts/refreshes/digital_portal_refresh/portal_halo_org.sql'
path = './Unit_Tests/customers.sql'
